...
namespace ExcelToJsonPlugin.Editor.UI
{
    ...
    public class DataPreviewDrawer
    {
        ...
        private void BuildCachedStyles()
        {
            ...
            cellStyle = new GUIStyle(EditorStyles.label) { normal = { textColor = Color.white } };
            cellBoldStyle = new GUIStyle(EditorStyles.label) { fontStyle = FontStyle.Bold };
            cellItalicStyle = new GUIStyle(EditorStyles.label) { fontStyle = FontStyle.Italic, normal = { textColor = new Color(0.4f, 0.4f, 0.4f) } };
            cellValidStyle = new GUIStyle(EditorStyles.label) { normal = { textColor = Color.white } };
            cellWarnStyle = new GUIStyle(EditorStyles.label) { normal = { textColor = new Color(0.9f, 0.7f, 0.1f) } };
            cellErrorStyle = new GUIStyle(EditorStyles.label) { normal = { textColor = new Color(0.9f, 0.2f, 0.2f) } };
            cellEmptyStyle = new GUIStyle(EditorStyles.label) { normal = { textColor = new Color(0.5f, 0.5f, 0.5f) } };
            cellResStyle = new GUIStyle(EditorStyles.label) { normal = { textColor = new Color(0.1f, 0.6f, 0.6f) } };
        ...
        private GUIStyle EvaluateCellStyle(string rawValue, FieldDef field)
        {
            ...
            {
                var v = value.ToLower();
                bool ok = v == "true" || v == "false" || v == "0" || v == "1" || v == "是" || v == "否" || v == "yes" || v == "no";
